...
<div class="main">
    ...
    <div class="div-set1" id="ipconfig">
        ...
        <div align="center"><a href="javascript:;" title="IP Config" data-toggle="modal" data-target="#exampleModal"
                               data-whatever="@mdo"> IP Config</a></div>
    </div>
    ...
    <div class="div-set3" id="bacnetconfig">
        <div align="center"><a href="#" id="" title="BACnet Config" data-toggle="modal" data-target="#BACCon">BACnet
                Config</a></div>
    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="message-text" class="control-label">Max_frame</label>
                            <ul class="inputgroup">
                                <input type="text" id="Max_frame">

                                <div style="clear:both"></div>
                            </ul>
                        </div>
                        <div class="form-group">
                            <label for="message-text" class="control-label">BacnetType</label>
                            <ul class="inputgroup">
                                <select id="BacnetType">
                                    <option value="0">BACnet IP</option>
                                    <option value="1">MS/TP</option>
                                </select>
